...
sbi_js_exists ||
  (!(function (e) {
    ...
    function t(i, s) {
      e.ajax({ url: sbiajaxurl, type: "post", data: i, success: s });
    }
    (i.prototype = {
      createPage: function (i, s) {
        void 0 !== sb_instagram_js_options.ajax_url &&
          ...
          e("#sbi-builder-app").length &&
            ...
            e(".sbi_resized_image_data").length &&
            void 0 !== e(".sbi_resized_image_data").attr("data-resized") &&
            0 ===
              e(".sbi_resized_image_data").attr("data-resized").indexOf('{"') &&
            ((window.sbiresizedImages = JSON.parse(
              e(".sbi_resized_image_data").attr("data-resized")
            )),
            ...
            var a = e(this),
              ...
              o =
                void 0 !== a.attr("data-options")
                  ...
                  : {};
            n.indexOf("testAjax") > -1 &&
              ((window.sbi.triggeredTest = !0),
              t({ action: "sbi_on_ajax_test_trigger" }, function (e) {
      ...
      encodeHTML: function (e) {
        ...
        var i = e.replace(/(>)/g, "&gt;"),
          i = i.replace(/(<)/g, "&lt;");
        return (i = i.replace(/(&lt;br\/&gt;)/g, "<br>")).replace(
          /(&lt;br&gt;)/g,
          "<br>"
        );
      },
      ...
      (s.prototype = {
        init: function () {
          ...
          (s.settings.consentGiven = s.checkConsent()),
            e(this.el).find(".sbi_photo").parent("p").length &&
              e(this.el).addClass("sbi_no_autop"),
            e(this.el).find("#sbi_mod_error").length &&
              e(this.el).prepend(e(this.el).find("#sbi_mod_error")),
        ...
        lazyLoadCheck: function (i) {
          if (
            i.find(".sbi_photo").length &&
            !i.closest(".sbi").hasClass("sbi-no-ll-check")
          ) {
            var s = this.getImageUrls(i),
              t =
                void 0 !== s[640]
                  ? s[640]
                  : i.find(".sbi_photo").attr("data-full-res");
            !(!this.settings.consentGiven && t.indexOf("scontent") > -1) &&
              i.find(".sbi_photo img").each(function () {
                t &&
                  void 0 !== e(this).attr("data-src") &&
                  e(this).attr("data-src", t),
                  t &&
                    void 0 !== e(this).attr("data-orig-src") &&
                    e(this).attr("data-orig-src", t),
                  e(this).on("load", function () {
                    !e(this).hasClass("sbi-replaced") &&
                      e(this).attr("src").indexOf("placeholder") > -1 &&
                      (e(this).addClass("sbi-replaced"),
                      t &&
                        (e(this).attr("src", t),
                        e(this).closest(".sbi_imgLiquid_bgSize").length &&
                          e(this)
        ...
        afterNewImagesRevealed: function () {
          this.listenForVisibilityChange(),
            ...
            this.settings.imageLoadEnabled ||
              e(".sbi_no_resraise").removeClass("sbi_no_resraise");
          var i = e.Event("sbiafterimagesloaded");
          (i.el = e(this.el)), e(window).trigger(i);
        },
        setResizedImages: function () {
          e(this.el).find(".sbi_resized_image_data").length &&
          void 0 !==
            e(this.el).find(".sbi_resized_image_data").attr("data-resized") &&
          0 ===
            e(this.el)
            ...
            ? ((this.resizedImages = JSON.parse(
              ...
              e(this.el).find(".sbi_resized_image_data").remove())
            : void 0 !== window.sbiresizedImages &&
        ...
        sendNeedsResizingToServer: function () {
          ...
          if (i.needsResizing.length > 0 && i.settings.resizingEnabled) {
            var a = e(this.el).find(".sbi_item").length,
              n =
                void 0 !== i.settings.general.cache_all &&
                i.settings.general.cache_all,
              o = "";
            if (
              (void 0 !== s.attr("data-locatornonce") &&
                (o = s.attr("data-locatornonce")),
              e("#sbi-builder-app").length)
            ) {
              if (
        ...
        getNewPostSet: function () {
          ...
          var a,
            n = "";
          void 0 !== i.attr("data-locatornonce") &&
            (n = i.attr("data-locatornonce")),
            t(
              {
              ...
              function (t) {
                ...
                "object" != typeof t &&
                  ...
                  a.feedStatus.shouldPaginate
                    ? (s.outOfPages = !1)
                    : ((s.outOfPages = !0), i.find(".sbi_load_btn").hide()),
                  e(".sbi_no_js").removeClass("sbi_no_js");
              }
            );
        },
        appendNewPosts: function (i) {
          ...
          s.find("#sbi_images .sbi_item").length
            ? s.find("#sbi_images .sbi_item").last().after(i)
            : s.find("#sbi_images").append(i);
        },
        ...
        maybeRaiseSingleImageResolution: function (i, s, t) {
          ...
          if (
            !(
              i.hasClass("sbi_no_resraise") ||
              i.hasClass("sbi_had_error") ||
              (i.find(".sbi_link_area").length &&
                i.find(".sbi_link_area").hasClass("sbi_had_error"))
            )
          ) {
            if (n.length < 1) {
              i.find(".sbi_link_area").length &&
            ...
            ((i.find(".sbi_link_area").length &&
              i.find(".sbi_link_area").attr("href") ===
                window.sbi.options.placeholder.replace(
                  "placeholder.png",
                  "thumb-placeholder.png"
                )) ||
              !a.settings.consentGiven) &&
              i.find(".sbi_link_area").attr("href", n[n.length - 1]),
              void 0 !== n[640] &&
                i.find(".sbi_photo").attr("data-full-res", n[640]),
            ...
            if (c > r || o === window.sbi.options.placeholder || t) {
              ...
              if (
                (o !== b && i.find(".sbi_photo img").attr("src", b),
                (r = c),
                ...
                i.find(".sbi_photo img").on("load", function () {
                  ...
                  if (1e3 !== s.get(0).naturalWidth && t > l && !u) {
                    ...
                    c > r &&
                      ((b = n[c].split("?ig_cache_key")[0]), s.attr("src", b)),
            ...
            i.find("img").on("error", function () {
              if (e(this).hasClass("sbi_img_error"))
                ...
                if (
                  (e(this).addClass("sbi_img_error"),
                  !(
                    e(this).attr("src").indexOf("media/?size=") > -1 ||
                    e(this).attr("src").indexOf("cdninstagram") > -1 ||
                    e(this).attr("src").indexOf("fbcdn") > -1
                  ) && a.settings.consentGiven)
                ) {
                  if (
                    "undefined" !==
                    e(this).closest(".sbi_photo").attr("data-img-src-set")
                  ) {
                    var i = JSON.parse(
                      e(this)
                        .closest(".sbi_photo")
        ...
        maybeRaiseImageResolution: function (i) {
          var s = this,
            t = !s.isInitialized;
          e(s.el)
            .find(void 0 !== i && !0 === i ? ".sbi_item.sbi_new" : ".sbi_item")
            .each(function (i) {
              !e(this).hasClass("sbi_num_diff_hide") &&
                e(this).find(".sbi_photo").length &&
                void 0 !==
                  e(this).find(".sbi_photo").attr("data-img-src-set") &&
                s.maybeRaiseSingleImageResolution(e(this), i, t);
            }),
            (s.isInitialized = !0);
        },
        ...
        hideExtraImagesForWidth: function () {
          if ("carousel" !== this.layout) {
            var i = e(this.el),
              s =
                void 0 !== i.attr("data-num") && "" !== i.attr("data-num")
                  ? parseInt(i.attr("data-num"))
                  : 1,
              t =
                void 0 !== i.attr("data-nummobile") &&
                "" !== i.attr("data-nummobile")
                  ? parseInt(i.attr("data-nummobile"))
                  : s;
            480 > e(window).width() || "mobile" === window.sbi_preview_device
              ? t < i.find(".sbi_item").length &&
                i
                  .find(".sbi_item")
                  .slice(t - i.find(".sbi_item").length)
                  .addClass("sbi_num_diff_hide")
              : s < i.find(".sbi_item").length &&
                i
                  .find(".sbi_item")
                  .slice(s - i.find(".sbi_item").length)
                  .addClass("sbi_num_diff_hide");
          }
        },
        setImageSizeClass: function () {
          ...
          var s = i.innerWidth(),
            t =
              parseInt(
                i.find("#sbi_images").outerWidth() -
                  i.find("#sbi_images").width()
              ) / 2,
            a = this.getColumnCount(),
            n = (s - t * (a + 2)) / a;
          n > 120 && n < 240
            ? i.addClass("sbi_medium")
            : n <= 120 && i.addClass("sbi_small");
        },
        setMinImageWidth: function () {
          e(this.el).find(".sbi_item .sbi_photo").first().length
            ? (this.minImageWidth = e(this.el)
        ...
        getImageUrls: function (e) {
          ...
          if (
            ...
            if (void 0 !== this.resizedImages[s].sizes) {
              var t = [],
                a =
                  void 0 !== this.resizedImages[s].extension
                    ? this.resizedImages[s].extension
                    : ".jpg";
        ...
        getAvatarUrl: function (e, i) {
          ...
          var s = this.settings.general.avatars,
            i = void 0 !== i ? i : "local";
          return "local" === i
            ? void 0 !== s["LCL" + e] && 1 === parseInt(s["LCL" + e])
              ? sb_instagram_js_options.resized_url + e + ".jpg"
              : void 0 !== s[e]
              ? s[e]
              : ""
            : void 0 !== s[e]
        ...
        listenForVisibilityChange: function () {
          ...
          (i = jQuery),
            ...
            "function" ==
              typeof e(this.el).filter(":hidden").sbiVisibilityChanged &&
              e(this.el)
                .filter(":hidden")
        ...
        checkConsent: function () {
          ...
          if (void 0 !== window.cookieyes)
            void 0 !== window.cookieyes._ckyConsentStore.get &&
              (this.settings.consentGiven =
                "yes" === window.cookieyes._ckyConsentStore.get("functional"));
          else if ("undefined" != typeof CLI_Cookie)
            ...
            void 0 !== window.cookieconsent
              ...
              : void 0 !== window.BorlabsCookie &&
                (this.settings.consentGiven =
                  void 0 !== window.BorlabsCookie.Consents
                    ? window.BorlabsCookie.Consents.hasConsent("instagram")
        ...
        locationGuess: function () {
          var i = e(this.el),
            s = "content";
          return (
            i.closest("footer").length
              ? (s = "footer")
              : i.closest(".header").length || i.closest("header").length
              ? (s = "header")
              : (i.closest(".sidebar").length || i.closest("aside").length) &&
                (s = "sidebar"),
            s
          );
        },
  ...
  jQuery(document).ready(function (e) {
    void 0 === window.sb_instagram_js_options &&
      ...
      e(".cli-user-preference-checkbox, .cky-notice button").on(
        "click",
        function () {
          setTimeout(function () {
            e.each(window.sbi.feeds, function (e) {
              window.sbi.feeds[e].checkConsent(),
                window.sbi.feeds[e].afterConsentToggled();
            });
          }, 1e3);
        }

!(function (e) {
  function t(t, a) {
    ...
    if (t.hasClass("premium-mask-yes") || i.length) {
      ...
      } else if ("premium-textual-showcase.default" === t.data("widget_type"))
        e = ".pa-txt-sc__effect-min-mask";
      ...
      var n = new IntersectionObserver(function (e) {
        e.forEach(function (e) {
          e.isIntersecting &&
            (i.length
              ? a(i).addClass("premium-mask-active")
